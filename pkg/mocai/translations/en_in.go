...
import (
	...
	address_mocks "github.com/brazzcore/mocai/pkg/mocai/entities/address/mocks/enin"
	gender_mocks "github.com/brazzcore/mocai/pkg/mocai/entities/gender/mocks/enin"
	person_mocks "github.com/brazzcore/mocai/pkg/mocai/entities/person/mocks/enin"
	phone_mocks "github.com/brazzcore/mocai/pkg/mocai/entities/phone/mocks/enin"
)
...
func init() {
	...
	Register("enin", map[string]string{
